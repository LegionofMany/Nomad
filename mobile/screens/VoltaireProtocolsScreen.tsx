  ...
  return (
    <NomadPage maxWidth={960}>
      ...
      <Panel style={[styles.sectionPanel, compact && styles.sectionPanelCompact]}>
        <View style={styles.sectionHeader}><View><Text style={[styles.sectionTitle, compact && styles.sectionTitleCompact]}>ARKRILIUM PROTOCOLS</Text><Text style={styles.sectionSubtitle}>Tap a protocol to inspect provider evidence</Text></View><Text style={styles.evidencePill}>● LOCAL EVIDENCE</Text></View>
