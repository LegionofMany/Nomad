...
For the practical developer task board, use:
...
| Phase 2D: Local compile/audit pass | Ready for developer | `mobile/nomad/PHASE_2D_LOCAL_AUDIT_CHECKLIST.md` and `NOMAD_DEVELOPER_EXECUTION_CHECKLIST.md` give the developer the install, typecheck, Expo launch, route smoke-test, and error-report workflow. |
...
The repository now includes a practical task board for the developer:
...
- Phase 2D local compile/audit tasks;
- the 26-screen route smoke test;
- Phase 2E wallet-engine integration tasks;
- Phase 3 live-service tasks;
- Phase 4 production release tasks;
- non-negotiable custody/signing guardrails;
...
2. Read `NOMAD_DEVELOPER_EXECUTION_CHECKLIST.md`.
3. Read `NOMAD_PHASE_ROADMAP.md`.
4. Read `mobile/nomad/NOMAD_LAYER_GUARDRAILS.md`.
5. Read `mobile/nomad/PHASE_1_WIRING_AUDIT.md`.
6. Read `mobile/nomad/PHASE_2_WALLET_ENGINE_HANDOFF.md`.
7. Read `mobile/nomad/PHASE_2C_SCREEN_READINESS_AUDIT.md`.
8. Read `mobile/nomad/PHASE_2D_LOCAL_AUDIT_CHECKLIST.md`.
9. Read `mobile/nomad/PHASE_2E_BASE_ENGINE_SELECTION.md`.
10. Read `mobile/nomad/PHASE_3_LIVE_SERVICES_PLAN.md`.
11. Read `mobile/nomad/PHASE_4_PRODUCTION_AUDIT_RELEASE.md`.
12. Run the local commands listed above.
13. Complete Phase 2D compile/audit pass.
14. Select/import the base engine.
15. Implement a concrete adapter beside `clonedWalletAdapterTemplate.ts`.
16. Inject the concrete adapter through `NomadAdaptersProvider`.
17. Replace local demo services with production service adapters.
18. Begin Phase 3 live Nomad service integrations.
19. Begin Phase 4 release audit only after live engine integration and live service integration are complete.

## Handoff conclusion

This repository is ready to hand to a developer as a Phase 1 overlay package with Phase 2 integration preparation, Phase 3 service planning, Phase 4 production release planning, and an execution checklist prepared. It is not ready for public release until Phase 2E, Phase 3, and Phase 4 are completed and passed.
